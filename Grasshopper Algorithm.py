...
get_ipython().run_line_magic('The', 'Grasshopper Optimization Algorithm')
...
get_ipython().run_line_magic('Initialize', 'the population of grasshoppers')
...
cMax=1;
cMin=0.00004;
get_ipython().run_line_magic('Calculate', 'the fitness of initial grasshoppers')
...
get_ipython().run_line_magic('Find', 'the best grasshopper (target) in the first population')
for newindex=1:N
...
get_ipython().run_line_magic('Main', 'loop')
...
while l<Max_iter+1
    ...
    get_ipython().run_line_magic('GrassHopperPositions', '')
    GrassHopperPositions=GrassHopperPositions_temp;
    
    for i=1:size(GrassHopperPositions,1)
        get_ipython().run_line_magic('Relocate', 'grasshoppers that go outside the search space')
        ...
        get_ipython().run_line_magic('Calculating', 'the objective values for all grasshoppers')
        if flag == 1
            GrassHopperFitness(1,i)=fobj(GrassHopperPositions(i,1:end-1));
        else
            GrassHopperFitness(1,i)=fobj(GrassHopperPositions(i,:));
        ...
        get_ipython().run_line_magic('Update', 'the target')
